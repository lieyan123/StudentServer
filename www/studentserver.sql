/*
 ...
 Source Schema         : studentserver

 Target Server Type    : MySQL
 Target Server Version : 50724
 File Encoding         : 65001

 Date: 16/01/2019 16:37:41
*/
...
CREATE TABLE `academy`  (
  ...
  `academy_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `academy_createtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `state` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '正常' COMMENT '正常/废弃',
...
INSERT INTO `access` VALUES (48, '发送消息', '/api/message/SendMessage');
...
CREATE TABLE `class_lesson`  (
  ...
  `team` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '大一上学期/大一下学期/大二上学期/大二下学期',
  PRIMARY KEY (`class_lesson_id`) USING BTREE,
  INDEX `major_id`(`class_id`) USING BTREE,
...
CREATE TABLE `classes`  (
  ...
  `Admission_time` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '入学时间',
  `year_id` int(11) NULL DEFAULT NULL COMMENT '学年制，4年或者五年',
...
-- Records of draft
-- ----------------------------
INSERT INTO `draft` VALUES (1, '测试', '<p>测试内容</p>');
INSERT INTO `draft` VALUES (3, '标题标题', '<p>第二个测试内容</p>');
INSERT INTO `draft` VALUES (4, '大家好', '<p>大家好，欢迎使用此系统</p>');
...
CREATE TABLE `lesson`  (
  ...
  `lesson_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lesson_hours` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `lesson_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '必修',
...
CREATE TABLE `major`  (
  ...
  `major_createtime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `message`  (
  ...
  `messageContext` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NULL,
  `state` int(11) NULL DEFAULT 0 COMMENT '0:未读 1：已读 -1：回收站',
  PRIMARY KEY (`msg_id`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
  CONSTRAINT `message_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE SET NULL ON UPDATE RESTRICT
...
INSERT INTO `message` VALUES (4, 1, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 1);
INSERT INTO `message` VALUES (5, 6, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (6, 7, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (7, 8, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (8, 9, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (9, 10, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (10, 11, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (11, 5, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (12, 2, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (13, 3, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (14, 12, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (15, 13, '大家好', '2019-01-15', '<p>大家好，欢迎使用此系统</p>', 0);
INSERT INTO `message` VALUES (16, 1, '无题', '2019-01-15', '在此写消息内容，会自动转为HTML格式', 1);
...
INSERT INTO `role_access` VALUES (73, 1, 48);
...
CREATE TABLE `student`  (
  ...
  `student_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '本科生' COMMENT '本科生，研究生，博士生',
  `birthday` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `native_place` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '籍贯',
  `Ethnicity` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '民族',
  `nation` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '国籍',
  `IDnumber` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '身份证号',
  `political_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '政治面貌 团员党员群众',
  `education` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '学历     大学本科，研究生',
  `health_condition` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '健康状况     良好',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `familyAddress` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `addressDetails` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '详细门牌号等',
  `email` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`student_id`, `student_num`) USING BTREE,
  INDEX `user_id`(`user_id`) USING BTREE,
...
CREATE TABLE `teacher`  (
  ...
  `teacher_status` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '讲师' COMMENT '讲师，教授，副教授',
  `user_id` int(11) NULL DEFAULT NULL,
  `academy_id` int(11) NULL DEFAULT NULL,
...
CREATE TABLE `teacher_lesson`  (
  ...
  `lesson_id` int(11) NULL DEFAULT NULL,
  `class_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`teacher_lesson_id`) USING BTREE,
  INDEX `teacher_id`(`teacher_id`) USING BTREE,
  INDEX `lesson_id`(`lesson_id`) USING BTREE,
  INDEX `class_id`(`class_id`) USING BTREE,
...
CREATE TABLE `user`  (
  ...
  `state` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '启用' COMMENT '状态为启用或者禁用',
...
CREATE TABLE `user_role`  (
  ...
  INDEX `user_id`(`user_id`) USING BTREE,
  INDEX `access_id`(`role_id`) USING BTREE,
...
CREATE TABLE `years`  (
  ...
  `year_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `year_num` int(11) NULL DEFAULT NULL,
